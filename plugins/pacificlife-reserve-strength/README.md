...
**Hosted:** https://michellekoppel.github.io/millersigma/plugins/pacificlife-reserve-strength/index.html
(GitHub Pages, not jsDelivr — jsDelivr serves `.html` as `Content-Type:
text/plain`, which renders as raw source instead of executing.)
